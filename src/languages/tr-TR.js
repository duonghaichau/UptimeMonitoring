export default {
    ...
    "disableauth.message2": "Bu, Uptime ZaloPay'nın önünde Cloudflare Access gibi <strong>üçüncü taraf yetkilendirmesi olan</strong> kişiler içindir.",
    ...
    aboutKumaURL: "Uptime ZaloPay URL alanını boş bırakırsanız, varsayılan olarak Project GitHub sayfası olur.",
    ...
    trustProxyDescription: "'X-Forwarded-*' başlıklarına güvenin. Doğru istemci IP'sini almak istiyorsanız ve Uptime ZaloPay'nız Nginx veya Apache'nin arkasındaysa, bunu etkinleştirmelisiniz.",
