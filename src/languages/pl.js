export default {
    ...
    "disableauth.message2": "Jest przeznaczony dla <strong>kogoś, kto ma autoryzację zewnętrzną</strong> przed Uptime ZaloPay, taką jak Cloudflare Access.",
    ...
    "Uptime ZaloPay URL": "Adres Uptime ZaloPay",
    ...
    aboutKumaURL: "Jeśli pozostawisz pole Adres Uptime ZaloPay puste, domyślnie będzie to strona projektu na GitHub.",
    ...
    trustProxyDescription: "Zaufaj nagłówkom 'X-Forwarded-*'. Jeśli chcesz uzyskać poprawne IP klienta, a twój Uptime ZaloPay jest za Nginx lub Apache, powinieneś to włączyć.",
