export default {
    ...
    "disableauth.message2": "Έχει σχεδιαστεί για σενάρια <strong>όπου σκοπεύετε να εφαρμόσετε έλεγχο ταυτότητας τρίτου μέρους</strong> μπροστά από το Uptime ZaloPay, όπως το Cloudflare Access, Authelia ή άλλους μηχανισμούς ελέγχου ταυτότητας.",
    ...
    "Uptime ZaloPay URL": "Uptime ZaloPay URL",
    ...
    aboutKumaURL: "Εάν αφήσετε κενό το πεδίο URL Uptime ZaloPay, θα είναι προεπιλεγμένο στη σελίδα Project GitHub..",
    ...
    About: "Σχετικά με το Uptime ZaloPay",
    ...
    trustProxyDescription: "Εμπιστευτείτε τις κεφαλίδες 'X-Forwarded-*'. Εάν θέλετε να λάβετε τη σωστή IP πελάτη και το Uptime ZaloPay σας βρίσκεται πίσω το Nginx ή το Apache, θα πρέπει να το ενεργοποιήσετε.",
